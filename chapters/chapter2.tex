...
\sectiontoc{3. The Field Equations}
...
\sectiontoc{5. Rotational Perturbations}
...
\sectiontoc{6. Perturbations of Density}
...
gravitational forces will have an effect smaller than pressure equal \sectiontoc{7. The Steady-state Universe}
...
\sectiontoc{8. Gravitational Waves}
...
\sectiontoc{9. Absorption of Gravitational Waves}
